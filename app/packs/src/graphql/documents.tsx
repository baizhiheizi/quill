...
export type Mutation = {
  ...
  createAccessToken?: Maybe<UserAccessToken>;
...
export type Query = {
  ...
  createdAt: Scalars['ISO8601DateTime'];
  myAccessTokenConnection: UserAccessTokenConnection;
...
export type UserAccessTokenConnection = {
  __typename?: 'UserAccessTokenConnection';
  /** A list of edges. */
...
export type UserAccessTokenEdge = {
  __typename?: 'UserAccessTokenEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String'];
  /** The item at the end of the edge. */
