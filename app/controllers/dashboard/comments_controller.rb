...
class Dashboard::CommentsController < Dashboard::BaseController
  ...
  def index
    ...
    # `comment.commentable.title` → `user_article_path(commentable.author,
    # ...)` link, which walks the polymorphic `commentable` (`Article` /
    # `Collection`) plus its `author` User row. Same family of gaps closed in
    # PRs #1802/#1815/#1829/#1830/#1833/#1834/#1843 for the other dashboard
    # surfaces.
    comments =
      if @article.present?
