const notificationTpl = (type, message) => {
  switch (type) {
    case 'info':
      return `<div class="flex p-4 mb-4 bg-blue-100 rounded-lg dark:bg-blue-200" role="alert">
  ...
  <button type="button" 
    ...
    case 'danger':
      return `<div id="alert-2" class="flex p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200" role="alert">
  ...
  <button type="button" 
    ...
    case 'warning':
      return `<div id="alert-4" class="flex p-4 mb-4 bg-yellow-100 rounded-lg dark:bg-yellow-200" role="alert">
