...
ActiveRecord::Schema[7.1].define(version: 2023_12_14_012200) do
  ...
  create_table "kernel_outputs", force: :cascade do |t|
    t.uuid "asset_id"
    t.decimal "amount"
    t.string "state"
    t.json "raw"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["asset_id"], name: "index_kernel_outputs_on_asset_id"
  end
