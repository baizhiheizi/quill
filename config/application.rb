...
module Prsdigg
  class Application < Rails::Application
    ...
    config.i18n.available_locales = Rails.application.credentials[:available_locales] || %i[en]
    config.i18n.default_locale = Rails.application.credentials[:default_locale] || :en
