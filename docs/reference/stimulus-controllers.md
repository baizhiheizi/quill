...
| `modal-component` | [`flyonui_modal_controller.js`](../../app/javascript/controllers/flyonui_modal_controller.js) | FlyonUI-themed modal wrapper (registered as `modal-component` in `index.js`) |
