...
- `.github/workflows/check.yml` was the only repo workflow using `postgres:latest` until 2026-08-16; it now uses `pgvector/pgvector:pg16` to align with production (`config/deploy.yml`).
...
- Workflow Postgres image alignment (as of 2026-08-16):
