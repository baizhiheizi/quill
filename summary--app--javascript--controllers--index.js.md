...
| darkmode | darkmode_controller.js |
| dropdown | dropdown_controller.js |
| eth-wallet | eth_wallet_controller.js |
| fennec | fennec_controller.js |
| flash | flash_controller.js |
| floating | floating_controller.js |
| flyonui-dropdown | flyonui_dropdown_controller.js |
| hljs | hljs_controller.js |
...
| nested-form | nested_form_controller.js |
| photoswipe | photoswipe_controller.js |
| pre-orders-form-component | pre_orders_form_component_controller.js |
| pre-orders-mixpay-button-component | pre_orders_mixpay_button_component_controller.js |
| pre-orders-pay-button-component | pre_orders_pay_button_component_controller.js |
| pre-orders-payment-component | pre_orders_payment_component_controller.js |
| pre-orders-state-component | pre_orders_state_component_controller.js |
| prefetch | prefetch_controller.js |
